...
public class BoatPhysics : MonoBehaviour 
{
    ...
    void AddAboveWaterForces()
    {
        ...
        for (int i = 0; i < aboveWaterTriangleData.Count; i++)
        {
			...
			//Replace VisbyData.C_r with your boat's drag coefficient TODO: Make a data for the boat drag coefficient
            forceToAdd += BoatPhysicsMath.AirResistanceForce(rhoAir, triangleData, boat_c_R);
